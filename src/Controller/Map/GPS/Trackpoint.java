...
public class Trackpoint {
    ...
    public Trackpoint(double altitude, Latitude latitude, Longitude longitude, Date timestamp) {
    ...
    public Trackpoint(double altitude, Latitude latitude, Longitude longitude, Date timestamp,String name) {
        this(altitude, latitude, longitude, timestamp);
        this.Name=name;
    }
    ...
    /**
     * Returns a <code>Latitude</code> object containig a latitude coordinate of
    ...
    public String toString(){
        return altitude+"-"+longitude.getDecimal()+"-"+latitude.getDecimal();
    }
}
